...
Provides the Marketing Data API's client, built on sasci360apicore.rest_client's
...
@dataclass
class CI360DataConfig(RestClientConfig):
...
class CI360DataBase(RestClientBase):
    """
    Client for SAS CI360 Data operations.
    ...
    _CONFIG_CLS = CI360DataConfig
    _ERROR_CLS = CI360DataError
    _AUTH_ERROR_CLS = CI360DataAuthError
    _CONNECTION_ERROR_CLS = CI360DataConnectionError
    _VALIDATION_ERROR_CLS = CI360DataValidationError
