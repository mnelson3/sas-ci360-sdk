...
class Data:
    ...
    def create_csv(self, **kwargs) -> None:
        ...
        try:
            ...
            with open(file=in_file, mode="r", encoding="utf8") as in_f, \
                    open(file=out_file, mode="a", encoding="utf8") as out_f:
                rows = 0
                for line in in_f:
    ...
    def create_sas_dataset(self, **kwargs) -> Optional[saspy.SASdata]:
        ...
        try:
            ...
            for item in os.listdir(path=path):
                ...
                dataframe_collection[table_name] = pandas.read_csv(
                    filepath_or_buffer=file_path, sep="|", delimiter="|", encoding="utf8")
